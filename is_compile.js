...
function convertMiddle(i, e) {
	...
	var lookup = {
		...
		"Rn" : "(cpu.SetR(instruction.n, result),result)"
...
function convertLHS(i, e) {		
	...
	var lookup = {		
		...
		"pc_sr_to_stack": "cpu.PushSRPC()",
		"rts_hook": "cpu.RtsHook(),",
		"subroutine_hook": "cpu.SubroutineHook(),",
		"dt_rn" : "cpu.DtRn(instruction.n)",
		"swap_two_words_rm" : "cpu.SwapTwoWords(cpu.GetR(instruction.m))",
		"swap_bottom_two_bytes_rm" : "cpu.SwapBottomTwoBytes(cpu.GetR(instruction.m))",
		...
		"rn_plus_imm" : "cpu.GetR(instruction.n) + cpu.SignExtend(instruction.i, 8)",
		"rn_zeroextended": "cpu.ZeroExtend(instruction, cpu.GetR(instruction.n))",
		"rm_zeroextended": "cpu.ZeroExtend(instruction, cpu.GetR(instruction.m))",
		"with_unsigned_data": ", cpu.NotImplemented()",
		"with_signed_data": ", cpu.NotImplemented()",
		"sign_extend_imm": "cpu.SignExtend(instruction.i, 8)",
		"byte_sign_extend_rm" : "cpu.SignExtend(cpu.GetR(instruction.m), 8)",
		"word_sign_extend_rm" : "cpu.SignExtend(cpu.GetR(instruction.m), 16)",
		"rn_and_rm_have_an_equivalent_byte" : "cpu.EquivalentByte(cpu.GetR(instruction.n), cpu.GetR(instruction.m))",		
		...
		"rn_and_rm" : "!(cpu.GetR(instruction.n) & cpu.GetR(instruction.m))",
		"r0_and_imm" : "!(cpu.GetR(0) & instruction.i)",
		"rn_gt_eq_rm" : "cpu.GetR(instruction.n) >= cpu.GetR(instruction.m)",
		"rn_eq_rm" : "cpu.GetR(instruction.n) == cpu.GetR(instruction.m)",
		"rn_eq_zero" : "cpu.GetR(instruction.n) == 0",
		"rn_ge_zero" : "cpu.GetR(instruction.n) >= 0",
		"rn_ge_zero_signed" : "cpu.ToSigned(cpu.GetR(instruction.n)) >= 0",
		"rn_gt_zero_signed" : "cpu.ToSigned(cpu.GetR(instruction.n)) > 0",
		"r0_eq_imm" : "cpu.GetR(0) == cpu.ToUnsigned(cpu.SignExtendAddressComponent(instruction, 'i'))",
		"rn_ge_rm_signed" : "cpu.ToSigned(cpu.GetR(instruction.n)) >= cpu.ToSigned(cpu.GetR(instruction.m))",
		"rn_gt_rm_signed" : "cpu.ToSigned(cpu.GetR(instruction.n)) > cpu.ToSigned(cpu.GetR(instruction.m))",
		"rn_gt_rm_unsigned" : "cpu.GetR(instruction.n) > cpu.GetR(instruction.m)", 
		...
		"middle_32_bits_of_Rm_Rn" : "cpu.Middle32Bits(cpu.GetR(instruction.m), cpu.GetR(instruction.n))",
		...
		"Rn=Rm" : "cpu.GetR(instruction.n)==cpu.GetR(instruction.m)",		
		"GBR": "cpu.GetGBR()",
		"VBR": "cpu.GetVBR()",
		"SR": "cpu.GetSR()",
		"PR": "cpu.GetPR()",
		...
		"R0": "cpu.GetR(0)",		
		"FR0": "cpu.GetFR(0)",
		"~Rm" : "~cpu.GetR(instruction.m)",
		"Rm": "cpu.GetR(instruction.m)",
		"@Rm": "cpu.Read32(cpu.GetR(instruction.m))",
		"Rn": "cpu.GetR(instruction.n)",
		...
		"Rn–1" : "cpu.GetR(instruction.n)-1",
		"Rn–2" : "cpu.GetR(instruction.n)-2",
		"Rn–4" : "cpu.GetR(instruction.n)-4",
		"Rn–=4" : "cpu.SetR(instruction.n, cpu.GetR(instruction.n)-4),cpu.GetR(instruction.n)",
		"Rn+=4" : "cpu.SetR(instruction.n, cpu.GetR(instruction.n)+4),cpu.GetR(instruction.n)",
		"Rm–=4" : "cpu.SetR(instruction.m, cpu.GetR(instruction.m)-4),cpu.GetR(instruction.m)",
		"Rm+=4" : "cpu.SetR(instruction.m, cpu.GetR(instruction.m)+4),cpu.GetR(instruction.m)",
		"#imm": "instruction.i",				
		"imm": "instruction.i",
		...
		"rn_x_rm_16_x_16" : "cpu.To16Bit(cpu.GetR(instruction.n)) * cpu.To16Bit(cpu.GetR(instruction.m))", // TODO: Sign extend ?
		//"rn_x_rm_32_x_32" : "cpu.GetR(instruction.n) * cpu.GetR(instruction.m)", 
		"rn_x_rm_32_x_32" : "cpu.MultiplyUint32(cpu.GetR(instruction.n), cpu.GetR(instruction.m))", 
		
		"unsigned_rn_x_rm_16_x_16" : "cpu.To16Bit(cpu.GetR(instruction.n)) * cpu.To16Bit(cpu.GetR(instruction.m))",
	...
	if (e[0] == "(") {
		...
		return "cpu.Read"+i.instructionBitLength+"(" + convertLHS(i, e.slice(1, e.lastIndexOf(")"))) + ")";
	}
...
function convertRHS(i, e) {	
	var lookup = {
        ...
        "rot_with_carry_right_rn" : "cpu.ROTCR(instruction)",
        
        "RTE" : "cpu.RTE()",
        "TRAPA" : "cpu.TRAPA(instruction)",
        "TAS" : "cpu.TAS(instruction)",
		...
		//"(Rn)" : "cpu.Write(cpu.GetR(instruction.n), result, " + i.instructionBitLength + ")",
		"(Rn)" : "cpu.Write"+i.instructionBitLength+"(cpu.GetR(instruction.n), result)",
		"R0" : "cpu.SetR(0, result)",
		"FR0" : "cpu.SetFR(0, result)",
		//"@Rn" : "cpu.Write(cpu.GetR(instruction.n), result, " + i.instructionBitLength + ")",
		"@Rn" : "cpu.Write"+ i.instructionBitLength +"(cpu.GetR(instruction.n), result)",
		//"@Rm" : "cpu.Write(cpu.GetR(instruction.m), result, " + i.instructionBitLength + ")",
		"@Rm" : "cpu.Write"+ i.instructionBitLength +"(cpu.GetR(instruction.m), result)",
		"Rn" : "cpu.SetR(instruction.n, result)",
		...
		"Rn–=4" : "cpu.SetR(instruction.n, cpu.GetR(instruction.n)-4)",
		"Rn+=4" : "cpu.SetR(instruction.n, cpu.GetR(instruction.n)+4)",
		"Rm–=4" : "cpu.SetR(instruction.m, cpu.GetR(instruction.m)-4)",
		"Rm+=4" : "cpu.SetR(instruction.m, cpu.GetR(instruction.m)+4)",
		"T": "cpu.SetT(result)",
		"Q": "cpu.SetQ(result)",
		"M": "cpu.SetM(result)",
	...
	if (e[0] == "(" && e[e.length-1] ==")") {
		...
		return "var address = (" + convertLHS(i, e.slice(1, e.length-1)) + ");\n cpu.Write"+ i.instructionBitLength +"(address, result)";
	}	
...
function compile(i) {
	...
	if (notImplemented(expressions)) {
        ...
        expressions = expressions.replace("Delayed branch, stack area → PC/SR", "RTE")
        expressions = expressions.replace("PC/SR → stack area, (imm × 4 + VBR) → PC", "TRAPA")
        expressions = expressions.replace("If (Rn) is 0, 1 → T; 1 → MSB of (Rn)", "TAS")
		...
		expressions = expressions.replace("T → Rn → T", "rot_with_carry_right_rn")
